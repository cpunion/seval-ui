	...
	return (
		<div className="home-page">
			...
			<p className="description">
				This demo showcases how A2UI can use S-expressions for client-side logic, enabling
				interactive applications without server roundtrips while maintaining security (no arbitrary
				code execution).
			</p>
			...
			<div className="app-cards">
				<Link to="/showcase" className="app-card featured">
					...
					<p>
						A comprehensive demo of all A2UI components with data binding, templates, and
						S-expression logic.
					</p>
				...
				<Link to="/calculator" className="app-card">
					...
					<h2>Calculator</h2>
					<p>
						A simple calculator demonstrating immediate UI feedback. Digit input, operators, and
						calculations all handled locally via S-expressions.
					</p>
					<ul className="features">
				...
				<Link to="/vocabulary" className="app-card">
					...
					<p>
						A spaced repetition vocabulary app implementing the SM-2 algorithm. Study words, track
						progress, manage your word library.
					</p>
					<ul className="features">
			...
			<div className="tech-info">
				<h3>How it works</h3>
				<p>
					Both apps use A2UI's component model for the UI, but instead of sending actions to a
					server, they evaluate S-expression logic locally:
				</p>
